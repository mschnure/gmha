...
source("calibration/likelihood/individual_likelihoods.R") # make sure it's set to r1.upper.middle
...
params.manual["age.50.and.over.transmission.multiplier.0"] # 0.75028614
params.manual["age.50.and.over.transmission.multiplier.1"] = 0.25 # 0.07704944
params.manual["age.50.and.over.transmission.multiplier.2"] = 0.1 # 0.32557644
params.manual["age.50.and.over.transmission.multiplier.3"] # 0.10555604
