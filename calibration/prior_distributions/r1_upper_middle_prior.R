...
R1.UPPER.MIDDLE.PRIOR = join.distributions(
    ...
    hiv.specific.mortality.rates.0 = Lognormal.Distribution(log(0.04058323), log(4)/2), # see hiv.mortality.priors.R
    hiv.specific.mortality.rates.1 = Lognormal.Distribution(log(0.04112071), log(4)/2),
    hiv.specific.mortality.rates.2 = Lognormal.Distribution(log(0.01964554), log(4)/2),
    ...
    # age transmission multipliers -  updated 4/17/26
    age.15.to.19.multipliers = make.joint.distribution(median.r2 = 1, sd.r2=log(8)/2,
                                                       median.r0.to.r1 = 1, sd.r0.to.r1 = log(8)/2,
                                                       median.r1.to.r2 = 1, sd.r1.to.r2 = log(8)/2,
                                                       median.r3.to.r2 = 1, sd.r3.to.r2 = log(8)/2,
                                                       median.r4.to.r3 = 1, sd.r4.to.r3 = log(8)/2,
                                                       var.names = c("age.15.to.19.transmission.multiplier.0",
                                                                     "age.15.to.19.transmission.multiplier.1",
                                                                     "age.15.to.19.transmission.multiplier.2",
                                                                     "age.15.to.19.transmission.multiplier.3")), 
    
    age.20.to.29.multipliers = make.joint.distribution(median.r2 = 1, sd.r2=log(8)/2,
                                                       median.r0.to.r1 = 1, sd.r0.to.r1 = log(8)/2,
                                                       median.r1.to.r2 = 1, sd.r1.to.r2 = log(8)/2,
                                                       median.r3.to.r2 = 1, sd.r3.to.r2 = log(8)/2,
                                                       median.r4.to.r3 = 1, sd.r4.to.r3 = log(8)/2,
                                                       var.names = c("age.20.to.29.transmission.multiplier.0",
                                                                     "age.20.to.29.transmission.multiplier.1",
                                                                     "age.20.to.29.transmission.multiplier.2",
                                                                     "age.20.to.29.transmission.multiplier.3")), 
    
    age.40.to.49.multipliers = make.joint.distribution(median.r2 = 1, sd.r2=log(8)/2,
                                                       median.r0.to.r1 = 1, sd.r0.to.r1 = log(8)/2,
                                                       median.r1.to.r2 = 1, sd.r1.to.r2 = log(8)/2,
                                                       median.r3.to.r2 = 1, sd.r3.to.r2 = log(8)/2,
                                                       median.r4.to.r3 = 1, sd.r4.to.r3 = log(8)/2,
    ...
    age.50.and.over.multipliers = make.joint.distribution(median.r2 = 1, sd.r2=log(8)/2,
                                                          median.r0.to.r1 = 1, sd.r0.to.r1 = log(8)/2,
                                                          median.r1.to.r2 = 1, sd.r1.to.r2 = log(8)/2,
                                                          median.r3.to.r2 = 1, sd.r3.to.r2 = log(8)/2,
                                                          median.r4.to.r3 = 1, sd.r4.to.r3 = log(8)/2,
