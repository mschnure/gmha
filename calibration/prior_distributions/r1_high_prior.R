...
R1.HIGH.PRIOR = join.distributions(
    ...
    hiv.specific.mortality.rates.0 = Lognormal.Distribution(log(0.030366492), log(4)/2), # see hiv.mortality.priors.R
    hiv.specific.mortality.rates.1 = Lognormal.Distribution(log(0.009372276), log(4)/2),
    hiv.specific.mortality.rates.2 = Lognormal.Distribution(log(0.009372276), log(4)/2),
