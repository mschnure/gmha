...
ZIMBABWE.PRIOR = join.distributions(
    ...
    hiv.specific.mortality.rates.0 = Lognormal.Distribution(log(0.0375), log(4)/2), # see hiv.mortality.priors.R
    hiv.specific.mortality.rates.1 = Lognormal.Distribution(log(0.08571429), log(4)/2),
    hiv.specific.mortality.rates.2 = Lognormal.Distribution(log(0.01769231), log(4)/2),
