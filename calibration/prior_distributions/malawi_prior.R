...
MALAWI.PRIOR = join.distributions(
    ...
    hiv.specific.mortality.rates.0 = Lognormal.Distribution(log(0.04418605), log(4)/2), # see hiv.mortality.priors.R
    hiv.specific.mortality.rates.1 = Lognormal.Distribution(log(0.08131868), log(4)/2),
    hiv.specific.mortality.rates.2 = Lognormal.Distribution(log(0.01300000), log(4)/2),
