...
R1.LOW.PRIOR = join.distributions(
    ...
    hiv.specific.mortality.rates.0 = Lognormal.Distribution(log(0.04405254), log(4)/2), # see hiv.mortality.priors.R
    hiv.specific.mortality.rates.1 = Lognormal.Distribution(log(0.08336661), log(4)/2),
    hiv.specific.mortality.rates.2 = Lognormal.Distribution(log(0.02958205), log(4)/2),
