...
TANZANIA.PRIOR = join.distributions(
    ...
    hiv.specific.mortality.rates.0 = Lognormal.Distribution(log(0.0453125), log(4)/2), # see hiv.mortality.priors.R
    hiv.specific.mortality.rates.1 = Lognormal.Distribution(log(0.09090909), log(4)/2),
    hiv.specific.mortality.rates.2 = Lognormal.Distribution(log(0.019375), log(4)/2),
