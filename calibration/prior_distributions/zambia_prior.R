...
ZAMBIA.PRIOR = join.distributions(
    ...
    hiv.specific.mortality.rates.0 = Lognormal.Distribution(log(0.04285714), log(4)/2), # see hiv.mortality.priors.R
    hiv.specific.mortality.rates.1 = Lognormal.Distribution(log(0.06790123), log(4)/2),
    hiv.specific.mortality.rates.2 = Lognormal.Distribution(log(0.01692308), log(4)/2),
