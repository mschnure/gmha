...
R1.LOWER.MIDDLE.PRIOR = join.distributions(
    ...
    age.15.to.19.multipliers = make.joint.distribution(median.r2 = 1, sd.r2=log(4)/2,
                                                       median.r0.to.r1 = 1, sd.r0.to.r1 = log(4)/2,
                                                       median.r1.to.r2 = 1, sd.r1.to.r2 = log(4)/2,
                                                       median.r3.to.r2 = 1, sd.r3.to.r2 = log(4)/2,
    ...
    age.20.to.29.multipliers = make.joint.distribution(median.r2 = 1, sd.r2=log(4)/2,
                                                       median.r0.to.r1 = 1, sd.r0.to.r1 = log(4)/2,
                                                       median.r1.to.r2 = 1, sd.r1.to.r2 = log(4)/2,
                                                       median.r3.to.r2 = 1, sd.r3.to.r2 = log(4)/2,
    ...
    age.40.to.49.multipliers = make.joint.distribution(median.r2 = 1, sd.r2=log(4)/2,
                                                       median.r0.to.r1 = 1, sd.r0.to.r1 = log(4)/2,
                                                       median.r1.to.r2 = 1, sd.r1.to.r2 = log(4)/2,
                                                       median.r3.to.r2 = 1, sd.r3.to.r2 = log(4)/2,
    ...
    age.50.and.over.multipliers = make.joint.distribution(median.r2 = 1, sd.r2=log(4)/2,
                                                          median.r0.to.r1 = 1, sd.r0.to.r1 = log(4)/2,
                                                          median.r1.to.r2 = 1, sd.r1.to.r2 = log(4)/2,
                                                          median.r3.to.r2 = 1, sd.r3.to.r2 = log(4)/2,
