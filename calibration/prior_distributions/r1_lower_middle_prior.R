...
R1.LOWER.MIDDLE.PRIOR = join.distributions(
    ...
    hiv.specific.mortality.rates.0 = Lognormal.Distribution(log(0.03907204), log(4)/2), # see hiv.mortality.priors.R
    hiv.specific.mortality.rates.1 = Lognormal.Distribution(log(0.07346583), log(4)/2),
    hiv.specific.mortality.rates.2 = Lognormal.Distribution(log(0.02720530), log(4)/2),
