...
MOZAMBIQUE.PRIOR = join.distributions(
    ...
    hiv.specific.mortality.rates.0 = Lognormal.Distribution(log(0.04181818), log(4)/2), # see hiv.mortality.priors.R
    hiv.specific.mortality.rates.1 = Lognormal.Distribution(log(0.06583333), log(4)/2),
    hiv.specific.mortality.rates.2 = Lognormal.Distribution(log(0.02173913), log(4)/2),
