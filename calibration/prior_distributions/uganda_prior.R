...
UGANDA.PRIOR = join.distributions(
    ...
    hiv.specific.mortality.rates.0 = Lognormal.Distribution(log(0.06153846), log(4)/2), # see hiv.mortality.priors.R
    hiv.specific.mortality.rates.1 = Lognormal.Distribution(log(0.07), log(4)/2),
    hiv.specific.mortality.rates.2 = Lognormal.Distribution(log(0.014), log(4)/2),
