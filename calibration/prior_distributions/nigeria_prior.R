...
NIGERIA.PRIOR = join.distributions(
    
    # general 
    trates = make.joint.distribution(median.r0.to.r1 = 6.5, # 1990 relative to 1997
    ...
    hiv.specific.mortality.rates.0 = Lognormal.Distribution(log(0.04400000), log(4)/2), # see hiv.mortality.priors.R
    hiv.specific.mortality.rates.1 = Lognormal.Distribution(log(0.07647059), log(4)/2),
    hiv.specific.mortality.rates.2 = Lognormal.Distribution(log(0.03000000), log(4)/2),
