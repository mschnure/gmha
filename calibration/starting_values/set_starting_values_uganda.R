...
# initial run of 100,000 with 1/8 weight
  #load("mcmc_runs/simset_uganda_2025-07-29.Rdata")
# after that ^ initial run, ran 50,000 with 4x prevalence weight
load("mcmc_runs/simset_uganda_2025-08-13.Rdata")
...
save(params.start.values,file=("calibration/starting_values/2025_08_13_uganda_start_values.Rdata"))