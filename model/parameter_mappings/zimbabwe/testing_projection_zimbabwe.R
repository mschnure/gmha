...
get.testing.model.zimbabwe = function(){
    ...
    prop.1.female = c(.048,.090,.075,.068,.046) # earliest year (e.g., 2005)
    prop.1.male = c(.029,.086,.098,.073,.066) 
    prop.2.female = c(.184,.422,.441,.361,.264) # middle year (e.g. 2010)
    prop.2.male = c(.070,.221,.280,.257,.231) 
    prop.3.female = c(.298,.578,.607,.541,.434) # most recent year (e.g. 2015)
    prop.3.male = c(.194,.377,.501,.427,.377) 
