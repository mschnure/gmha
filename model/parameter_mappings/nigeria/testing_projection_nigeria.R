...
get.testing.model.nigeria = function(){
    ...
    testing.data.years =c(2003,2008,2013)-testing.anchor.year
    testing.data.ages = c(17,22,27,35,45) # midpoint of age groups:  15-19, 20-24, 25-29, 30-39, 40-49

    prop.1.female = c(.017,.033,.053,.032,.018) # earliest year (e.g., 2005)
    prop.1.male = c(.013,.075,.071,.081,.056) 
    prop.2.female = c(.022,.084,.103,.080,.034) # middle year (e.g. 2010) 
    prop.2.male = c(.022,.056,.079,.091,.063) 
    prop.3.female = c(.042,.123,.153,.123,.063) # most recent year (e.g. 2015)
    prop.3.male = c(.023,.094,.130,.135,.109) 
