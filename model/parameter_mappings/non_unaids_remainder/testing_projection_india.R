...
get.testing.model.india = function(){
    ...
    testing.data.years =c(2005,2015,2019)-testing.anchor.year
    testing.data.ages = c(17,22,27,35,45) # midpoint of age groups:  15-19, 20-24, 25-29, 30-39, 40-49

    prop.1.female = c(.009,.044,.057,.030,.013) # earliest year (e.g., 2005)
    prop.1.male = c(.005,.022,.048,.050,.031) 
    prop.2.female = c(.019,.090,.108,.058,.023) # middle year (e.g. 2010)
    prop.2.male = c(.007,.023,.048,.042,.029) 
    prop.3.female = c(.017,.091,.113,.071,.028) # most recent year (e.g. 2015)
    prop.3.male = c(.011,.025,.047,.046,.033) 
